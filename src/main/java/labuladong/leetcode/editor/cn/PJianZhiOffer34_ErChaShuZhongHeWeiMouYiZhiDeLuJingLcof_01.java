 ...
 *
 * @author DY
 * @date 2023-07-31 19:31:33
 */
public class PJianZhiOffer34_ErChaShuZhongHeWeiMouYiZhiDeLuJingLcof_01 {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new PJianZhiOffer34_ErChaShuZhongHeWeiMouYiZhiDeLuJingLcof_01().new Solution();
    }
...
//leetcode submit region begin(Prohibit modification and deletion)
    ...
    class Solution {
        public List<List<Integer>> pathSum(TreeNode root, int target) {
            ...
            dfs(root, target, new LinkedList<Integer>(), res);
            return res;
        }
