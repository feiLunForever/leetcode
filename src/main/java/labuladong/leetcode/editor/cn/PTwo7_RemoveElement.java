 ...
 *
 * <div>👍 1859, 👎 0<span style='float: right;'></span></div>
 */
 ...
 *
 * @author DY
 * @date 2023-07-18 16:41:24
 */
public class PTwo7_RemoveElement {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new PTwo7_RemoveElement().new Solution();
    }
