 ...
 *
 * @author DY
 * @date 2023-09-19 18:46:41
 */
public class PJianZhiOffer58I_FanZhuanDanCiShunXuLcof_01 {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new PJianZhiOffer58I_FanZhuanDanCiShunXuLcof_01().new Solution();
    }
