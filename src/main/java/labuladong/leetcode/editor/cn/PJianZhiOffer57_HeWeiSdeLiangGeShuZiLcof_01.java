 ...
 *
 * @author DY
 * @date 2023-08-03 16:01:46
 */
public class PJianZhiOffer57_HeWeiSdeLiangGeShuZiLcof_01 {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new PJianZhiOffer57_HeWeiSdeLiangGeShuZiLcof_01().new Solution();
    }
