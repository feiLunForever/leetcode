 ...
 *
 * @author DY
 * @date 2023-09-04 18:59:11
 */
public class PTwo6_RemoveDuplicatesFromSortedArray_01 {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new PTwo6_RemoveDuplicatesFromSortedArray_01().new Solution();
    }
