...
public class P304_RangeSumQuery2dImmutable {
    public static void main(String[] args) {
        //测试代码
        System.out.println(new P304_RangeSumQuery2dImmutable().new NumMatrix(new int[][]{{3, 0, 1, 4, 2}, {5, 6, 3, 2, 1}, {1, 2, 0, 1, 5}, {4, 1, 0, 1, 7}, {1, 0, 3, 0, 5}}).sumRegion(2, 1, 4, 3));
    }
...
//leetcode submit region begin(Prohibit modification and deletion)
    class NumMatrix {
        ...
        private int[][] preNum; // [0,0,i-1,j-1] 的前缀和
